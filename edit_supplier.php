...
$query="SELECT * FROM supplier WHERE id='$clientId'";
...
if(isset($_POST['delete'])){
    $alertMessage = "<div class='alert alert-danger'>
                        <p>Are you sure you want to delete this supplier? No take backs!</p><br>
...
if(isset($_POST['confirm-delete'])){
    ...
    $query="DELETE FROM `supplier` WHERE id='$clientId';";
    $result=mysqli_query($conn,$query);
    if($result){
